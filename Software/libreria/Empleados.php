<?php
    class Empleados implements IPersona
    {
        function Guardar($idEmpleado, $nombre, $apellidos, $telefono, $correo, $porcentaje, $imagen)
        {
            ...
            $query->bind_param('isss', $idEmpleado, $nombre, $apellidos, $telefono, $correo, $porcentaje, $imagen);
            $query->execute();
            $query->close();
        }
        function Mostrar($filtro)
        {
            ...
            $rs = '
                    ...
                    <thead><tr><th>Nombre</th><th>Apellidos</th><th>Teléfono</th><th>Correo</th><th>Porcentaje</th><th>Imagen</th><th>Acciones</th></tr></thead>
                    <tbody>';
            while($query->fetch())
            {
                $rs.= '<tr>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="staticBackdropLabel">Edición de Empleado</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <form id="formularioEmpleadoEdit" action="empleados" method="post">
