    ...
    class Clientes implements IPersona
    {
        ...
        function Mostrar($filtro)
        {
            ...
            $rs = '
                    ...
                    <thead><tr><th class="fs-5 text-azul1">Nombre</th><th class="fs-5 text-azul1">Teléfono</th><th class="fs-5 text-azul1">Correo</th><th class="fs-5 text-azul1">Acciones</th></tr></thead>
                    <tbody>';
            while($query->fetch())
            {
                $rs.= '<tr>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header modaltitulo">
                            <h5 class="modal-title fs-5" id="staticBackdropLabel">Edición de Cliente</h5>
