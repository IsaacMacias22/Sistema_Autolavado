<section class="container-xl">
  <h2 class="text-center mt-4 pb-4 border-bottom border-1 text-white">Tipos</h2>
  <div class="row w-100 mb-4 mt-4">
    <div class="d-flex justify-content-end">
      <form action="tipos" method="post">
        <div class="input-group">
            <input type="text" class="form-control bgblanco1" placeholder="Descripción" aria-label="Descripción" aria-describedby="botonbuscartipo" id="inputBuscarTipo" name="inputBuscarTipo">
