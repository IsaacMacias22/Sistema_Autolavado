<section class="container-xl">
  <h2 class="text-center mt-4 pb-4 border-bottom border-1 text-light">Clientes</h2>
    ...
    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#staticBackdropNuevo" id="botonclientenuevo">
      ...
      <form action="clientes" method="post">
        <div class="input-group">
            <input type="text" class="form-control bgblanco1" placeholder="Cliente" aria-label="Cliente" aria-describedby="botonbuscarcliente" id="inputBuscarCliente" name="inputBuscarCliente">
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header modaltitulo">
              <h5 class="modal-title fs-5" id="staticBackdropLabel">Nuevo Cliente</h5>
