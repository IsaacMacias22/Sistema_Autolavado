    ...
    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#staticBackdropNuevo" id="botonclientenuevo">
      ...
      <form action="empleados" method="post">
        <div class="input-group">
            <input type="text" class="form-control" placeholder="Empleado" aria-label="Empleado" aria-describedby="botonbuscarempleado" id="inputBuscarEmpleado" name="inputBuscarEmpleado">
